...
export const serverNode = {
  ...
  getMoviesList: async (page, perPage) => {
    try {
      const data = await axios.get(
        apiNode.baseUrl + "films?page=" + page + "&perPage=" + perPage
      );
      return data;
    } catch (error) {
      return error.response;
  ...
  addGenreMovie: async (filmID, genre) => {
    try {
      const data = await axios.post(
        apiNode.baseUrl + "films/genres/" + filmID,
        { genre }
      );
      return data;
    } catch (error) {
  ...
  getGenreMovie: async (filmID) => {
    try {
      const data = await axios.get(
        apiNode.baseUrl + "films/" + filmID + "/genres"
      );
      return data;
    } catch (error) {
      return error.response;
  ...
  removieGenreMovie: async (filmID, genre) => {
    try {
      const data = await axios.post(
        apiNode.baseUrl + "films/genres/" + filmID + "/remove",
        { genre }
      );
      return data;
    } catch (error) {
  ...
  getCastMovie: async (filmID) => {
    try {
      const data = await axios.get(
        apiNode.baseUrl + "films/" + filmID + "/casts"
      );
      return data;
    } catch (error) {
      return error.response;
  ...
  addCastMovie: async (filmID, cast) => {
    try {
      const data = await axios.post(apiNode.baseUrl + "films/casts/" + filmID, {
        cast,
      });
      return data;
    } catch (error) {
  ...
  removeCastMovie: async (filmID, cast) => {
    try {
      const data = await axios.post(
        apiNode.baseUrl + "films/casts/" + filmID + "/remove",
        { cast }
      );
      return data;
    } catch (error) {
  ...
  getKeywordMovie: async (filmID) => {
    try {
      const data = await axios.get(
        apiNode.baseUrl + "films/" + filmID + "/keywords"
      );
      return data;
    } catch (error) {
      return error.response;
  ...
  addKeywordMovie: async (filmID, keyword) => {
    try {
      const data = await axios.post(
        apiNode.baseUrl + "films/keywords/" + filmID,
        { keyword }
      );
      return data;
    } catch (error) {
  ...
  removeKeywordMovie: async (filmID, keyword) => {
    try {
      const data = await axios.post(
        apiNode.baseUrl + "films/keywords/" + filmID + "/remove",
        { keyword }
      );
      return data;
    } catch (error) {
